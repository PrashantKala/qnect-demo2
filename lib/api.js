...
export const phoneLogin = (idToken) => {
  return webApi.post('/auth/phone', { idToken });
};
...
export const fetchReviews = () => {
  return webApi.get('/reviews');
};

export const submitReview = (payload) => {
  return webApi.post('/reviews', payload);
};
...
export const deleteAccount = () => {
  return webApi.delete('/users/me');
};

// --- Guardian Functions ---
export const addGuardian = (guardianData) => {
  return webApi.post('/users/me/guardians', guardianData);
};

export const deleteGuardian = (guardianId) => {
  return webApi.delete(`/users/me/guardians/${guardianId}`);
};
...
export const updateQRVehicleNumber = (qrId, vehicleNumber) => {
  return webApi.post(`/qrs/${qrId}/update-vehicle`, { vehicleNumber });
};
...
export { webApi };
export const fetchQRInfo = (qrId) => {
  return webApi.get(`/qrs/${qrId}/info`);
};

// --- Self-Registration (Claim) ---
export const claimQR = (qrId, userData) => {
  return webApi.post(`/qrs/${qrId}/claim`, userData);
};
