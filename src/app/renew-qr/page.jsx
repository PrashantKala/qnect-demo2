...
function RenewQRContent() {
    ...
    const handleRenewal = async () => {
        ...
        try {
            ...
            const orderResponse = await fetch(`https://qnect.in/api/payments/renew/create-order`, {
                method: 'POST',
                headers: {
            ...
            const options = {
                ...
                handler: async function (response) {
                    ...
                    try {
                        const verifyResponse = await fetch(`https://qnect.in/api/payments/renew/verify`, {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'Authorization': `Bearer ${token}`,
