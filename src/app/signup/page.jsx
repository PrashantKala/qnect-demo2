        ...
        <div className="card">
          ...
          <div className="mb-6">
            ...
            <Link
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-3 border border-gray-300 rounded-lg text-text-secondary hover:bg-gray-50 transition-colors bg-white shadow-sm mt-3"
            >
